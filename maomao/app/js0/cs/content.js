...
//
    ...
    $(document).ready(function () {
        ...
        // post page meta to BG
        page_meta = {
            "html_title": document.title,

            // NOTE: these meta values are STALE on YT nav's history-push nav's...
            "og_title": $('meta[property="og:title"]').attr('content'),
            "og_image": cslib_get_meta_tag("og:image"), //$('meta[property="og:image"]').attr('content'),
            "og_sitename": cslib_get_meta_tag("og:site_name"), //$('meta[property="og:site_name"]').attr('content'),
            "og_type": cslib_get_meta_tag("og:type"), //$('meta[property="og:type"]').attr('content'),

            // itemprops ("microdata") -- not stale on YT nav's
            ...
            "ip_name": $('meta[itemprop="name"]').attr('content'),
            "ip_description": $('meta[itemprop="description"]').attr('content'),
            "ip_thumbnail_url": $('link[itemprop="thumbnailUrl"]').attr('href'),
            "ip_embed_url": $('link[itemprop="embedURL"]').attr('href'),
            "ip_genre": $('meta[itemprop="genre"]').attr('content'),
        };
        ...
        //var div = document.createElement('div'); // stops google.com search results being clickable...
...
//
    ...
    function cslib_get_meta_tag(tag_name) {

...
const renderSuggestion = (suggestion) => {
  ...
  return (
    <div className='search-media'>
      <div className='search-media-left'><amp-img layout='responsive' src={suggestion.avatar} className='img-object' alt='' width={40} height={40} /></div>
                  ...
                  <li key={guid()} className='search-item tags-color-1'>
                    <div className='search-media'>
                      <div className='search-media-left'>
                        <amp-img layout='responsive' src={item.avatar || '/static/images/no-image.png'} alt={item.label} className='img-object' width={40} height={40} />
                      </div>

...
var InviteStore = (_class = function InviteStore(isServer, shareCode, isLogin, isInstall) {
  ...
  _initDefineProp(this, 'shareCode', _descriptor3, this);
...
function initStore(isServer) {
  ...
  var isInstall = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;

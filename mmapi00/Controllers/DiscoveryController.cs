...
namespace mmapi00.Controllers
{
    ...
    public class DiscoveryController : ApiController
    {
        ...
        public IHttpActionResult DiscoveryUser_Root(long user_id, string hash, int page_num = 0, int per_page = 60, string country = null, string city = null)
        {
        ...
        [HttpGet]
        [CacheOutput(ClientTimeSpan = 60 * 60 * 1, ServerTimeSpan = 60 * 60 * 1)] // 1 hr / 1 hrs
        public IHttpActionResult Discovery_Term(long user_id, string hash, long term_id, int page_num = 0, int per_page = 60, string country = null, string city = null)
        {
            if (!UserAuth.Ok(user_id, hash)) return Unauthorized();

...
namespace mm_svc
{
    public static class UrlRecorder
    {
        ...
        //
        public static UrlInfo.UrlParent RecordUrl(string href, string raw_text, string document_head_hash, out long? url_id, out long? tld_topic_id)
        {
            url_id = null;

...
namespace tests
{
    ...
    public class Test_Golden
    {
        ...
        public void CalculatePathsToRoot_Test1()
        {
            ...
            //GoldenPaths.CalculatePathsToRoot(6334777); // Wesley So // Chess grandmasters #NS=2 / Chess titles #NS=4 / Chess #NS=12 / Competitive games #NS=2 / Games #NS=8 / Main topic classifications #NS=2
            //                                                                                                                   ^^^

            // not perfect -- best naive match is "films", but maybe closer parent "animated films" could inherit some boost?
            ...
            //GoldenPaths.CalculatePathsToRoot(5078100); // Superheroes // Heroes by role #NS=2 / Heroes #NS=9 / Mythological characters #NS=2 / People #NS=11 / Main topic classifications #NS=2
            //                                            ^^^                                  
            ...
            //GoldenPaths.CalculatePathsToRoot(5249821);  // American superheroes #NS=1 / Superheroes by type #NS=2 / Superheroes #NS=6 / Fictional characters by superhuman feature or ability #NS=2 / Fictional characters #NS=6 / People #NS=11 / Main topic classifications #NS=2
            //                                                                 ^^^                                  
            ...
            //GoldenPaths.CalculatePathsToRoot(5209410);  // Feminists by nationality #NS=2 / Feminists #NS=3 / People by political orientation #NS=2 / People #NS=11 / Main topic classifications #NS=2
            //                                       ^^^                                  

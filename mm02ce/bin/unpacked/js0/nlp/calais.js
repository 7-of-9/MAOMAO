...
//
    ...
    function nlp_calais(page_meta, test_data, url) {
        var nlp_items = [];
        var nlp = null;
        ...
        $.ajax({
          ...
          //async: false,
            ...
            headers: {
                "X-AG-Access-Token":
    millis % 3 == 0 ? "mhoonLzHshbRvxEntzN69xBuWEv3tKKA" // dom@d0m1.com
  : millis % 3 == 1 ? "br0jDjG8tn0VT74RfkJr4fVGXGic3YGm" // dom@tradehero.mobi
                    : "SUTbnG9YzIEKw2OxKxXqSCLguSqQkcET" // dom@lamoto.co.uk
                    ,
